...
def test_dataloader():
    ...
    train_loader, val_loader = get_dataloaders(["../chess_engine/data/positions_short3.pt"], config["data"])
    ...
    for batch in train_loader:
        ...
        keys = ['eval', 'move_target', 'king_square', 'check', 'threat_target', 'terminal_flag']
        for key in keys:
